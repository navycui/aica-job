...
JAVA_TOOL_OPTIONS=" -javaagent:/deploy/wt7/lib/wsthxt.jar -Xbootclasspath/p:/deploy/wt7/lib/wsthx.jar -Dwclh.file=/deploy/wt7/config/ai-common/settings.ini -DW_INAME=ai-common" 
