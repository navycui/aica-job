package aicluster.tsp.api.front.usereqst.estmt.service;
...
@Slf4j
@Service
public class UseReqstEstmtService {
    ...
    public void postEstmt(UseReqstEstmtParam param){
        ...
        param.setEstmtId(CoreUtils.string.getNewId("estmt-"));
        ...
        //접수번호
        //param.setRceptNo("testNo");
        //param.setReqstSttus(TspCode.reqstSttus.APPROVE.toString());
        tsptFrontUseReqstDao.insertEstmt(param);
    }
