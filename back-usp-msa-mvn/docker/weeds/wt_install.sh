...
mkdir -p /logs_data/wt7/logs/ai-mvn &&
mv /deploy/wt7/config/settings_sample /deploy/wt7/config/ai-mvn  &&
...
sleep 5 &&
mv -f /deploy/jdbc.map  /deploy/wt7/config/ai-mvn/_global/ &&
mv -f /deploy/wt7/settings.ini  /deploy/wt7/config/ai-mvn/ 
